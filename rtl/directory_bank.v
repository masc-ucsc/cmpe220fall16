...
`ifndef DR_PASSTHROUGH
 ...
 //not too much, see above, make this change first and see if compiles
  ...
  always_comb begin
    ...
    mem_ack_gen_req_retry = tag_req_ff_stage_next_retry || tag_bank_read_next_retry;
  ...
  always_comb begin
    ...
    end else if(l2todr_req_gen_valid || mem_ack_gen_req_valid) begin
