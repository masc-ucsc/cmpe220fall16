...
// Directory. Cache equivalent to #Cores * #Slices * L2 Size * "Safety Value" / #Directories / 8 Way assoc
//
// Config size 8 way
//
// Assume a 64bytes line
//
// Conf Pending Requests. Only queue for requests
//
//
...
`ifndef DR_PASSTHROUGH
  ...
  //OUSTANDING REQUEST BUFFER START, 1
  ...
  //OUSTANDING REQUEST BUFFER END, 1

  
  //These signals determine the request generated by an L2. The signals are sent to an arbiter to determine who gets access to the RAM banks
  ...
  //MEMTODR REQ ARBITER END, 6
  

  //ENTRY BANK SNACK GENERATION START, 7
  ...
  //ENTRY BANK SNACK GENERATION END, 7
  ...
  //DRTOMEM PRFETCH END, 14

  //MEMTODR ACK START, 15
  ...
  //RELEASE OUTSTANDING REQUEST ARBITER START, 16
  ...
  //RELEASE OUTSTANDING REQUEST ARBITER END, 16
